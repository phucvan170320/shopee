...
import { formatCurrency, generateNameId } from '../../utils/ultils'
...
export default function Cart() {
  ...
  return (
    <div className='flex  flex-col items-center justify-center bg-neutral-100 py-16'>
      <div className='container '>
        ...
        <div className='sticky bottom-0 z-10 mt-8 flex flex-col rounded-sm border border-gray-100 bg-white p-5 shadow sm:flex-row sm:items-center'>
          <div className='flex items-center'>
            ...
            <button className='mx-3 border-none bg-none'>Chọn tất cả {extendedPurchases.length} SP </button>
