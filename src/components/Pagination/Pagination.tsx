...
// page : là page current là page hiện tại
//pageSize : là tổng số trang (page)
...
function Pagination({ queryConfig, pageSize }: Props) {
  ...
  return (
    ...
    //   <button className='mx-2 cursor-pointer rounded-lg bg-white px-3 py-2 shadow-sm'>Prev</button>
    //   {renderPagination()}
    //   <button className='mx-2 cursor-pointer rounded-lg bg-white px-3 py-2 shadow-sm'>Next</button>
    // </div>
    <div className='mt-6 flex flex-wrap justify-center'>
      {page === 1 ? (
